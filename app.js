...
.forEach((music) => {
  ...
  const realIndex = playlist.indexOf(music);

  musicList.innerHTML += `
    <div class="music-card" onclick="playMusic(${realIndex})">
      ...
      <div class="music-actions">
        ...
        onclick="event.stopPropagation();addToQueue(${realIndex})">
        +
        </button>

        <button class="play-btn"
        onclick="event.stopPropagation();playMusic(${realIndex})">
        ▶
        </button>
